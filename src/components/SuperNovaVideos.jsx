            ...
            {posts.length > 0 && (
              <>
                ...
                <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                  <div className="w-16 h-16 md:w-20 md:h-20 bg-cyan-400/20 backdrop-blur-sm rounded-full border-2 border-cyan-400 flex items-center justify-center shadow-[0_0_20px_rgba(34,211,238,0.6)]">
            ...
            {posts.map((post, idx) => {
              ...
              return (
                ...
                >
                  ...
                  />
                  <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                    <div className="w-8 h-8 bg-black/40 backdrop-blur-[1px] rounded-full border border-cyan-400 flex items-center justify-center">
                      <Play className="text-cyan-400 fill-cyan-400 ml-0.5" size={12} />
                    </div>
                  </div>
